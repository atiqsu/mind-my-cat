...
class Ajax_Reject_Previsit_Date
{
    public function __construct()
    {
        add_action('wp_ajax_mmc_reject_previsit_date', [$this, 'handle']);
    }
    ...
    public function handle()
    {
        ...
        Contract::update([
            'status' => Config::CONTRACT_STATUS_SITTER_REJECTED
        ],[
            'id' => $contract_id
        ]);
        ...
        echo json_encode([
            'success' => true,
            'message' => 'Previsit date rejected successfully',
